...
pub fn meta_deser_unchecked<R: std::io::Read>(reader: &mut R) -> Result<Metadata, BorshError> {
    ...
    let collection_res: Result<Option<Collection>, BorshError> = BorshDeserialize::deserialize_reader(reader);
